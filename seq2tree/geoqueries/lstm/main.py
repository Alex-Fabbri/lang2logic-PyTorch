...
if __name__ == "__main__":
    ...
    main_arg_parser.add_argument('-dropoutrec',type=float,default=0.2,help='dropout for regularization, used after each c_i. 0 = no dropout')
    main_arg_parser.add_argument('-enc_seq_length',type=int, default=40,help='number of timesteps to unroll for')
    main_arg_parser.add_argument('-dec_seq_length',type=int, default=120,help='number of timesteps to unroll for')
    ...
    main_arg_parser.add_argument('-max_epochs',type=int, default=110,help='number of full passes through the training data')
    main_arg_parser.add_argument('-opt_method', type=int,default=0,help='optimization method: 0-rmsprop 1-sgd')
    main_arg_parser.add_argument('-learning_rate',type=float, default=0.005,help='learning rate')
    main_arg_parser.add_argument('-init_weight',type=float, default=0.08,help='initailization weight')
    main_arg_parser.add_argument('-learning_rate_decay',type=float, default=0.97,help='learning rate decay')
